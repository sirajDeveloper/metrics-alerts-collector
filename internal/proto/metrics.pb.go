...
const file_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseBCZAgithub.com/sirajDeveloper/metrics-alerts-collector/internal/protob\x06proto3"
