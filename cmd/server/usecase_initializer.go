...
func NewUseCaseInitializer(cfg *Config, metricRepo repository.MetricRepository, fileStorage *file.JSONFileStorage, healthChecker usecase.DatabaseHealthChecker) *UseCaseInitializer {
...
func (u *UseCaseInitializer) Initialize() *UseCaseResult {
	emitter := usecase.NewMetricsEmitterService(u.fileStorage, u.metricRepo, *u.config.StoreInterval)
